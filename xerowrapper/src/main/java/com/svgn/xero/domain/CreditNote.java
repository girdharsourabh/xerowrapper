 ...
 *         &lt;element name="AppliedAmount" type="{}itemPrice" minOccurs="0"/>
    ...
    implements DataContractBase
{
    ...
    @XmlElement(name = "Date", required = true, type = String.class, nillable = true)
    ...
    @XmlList
    @XmlElement(name = "LineAmountTypes", nillable = true)
    ...
    @XmlElement(name = "FullyPaidOnDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
